                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="images p-3">
                                ...
                                <div class="text-center p-4" style="display: flex; justify-content: center">
                                    <img id="main-image" src="images/<?php echo $images[0]['name']; ?>" width="250"/>
                                </div>
                                <div class="thumbnail text-center mt-4" style="display: flex; justify-content: space-evenly">
                                    <?php
                                    foreach ($images as $row) {
                                        echo '<img onclick="change_image(this)" src="images/' . $row["name"] . '" width="100">';
                                    }
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="product p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="index.php" style="color: black; border-bottom: black; font-size: 16px" class="ml-1">Back</a></div>
