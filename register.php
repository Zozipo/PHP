...
<div class="container" style="background: whitesmoke; height: 100vh">
            ...
            <div class="image_area" style="width: 160px">
                <form method="post" >
                    <label for="upload_image">
                        <img src="images/user.png" id="uploaded_image" class="img-responsive img-circle" width="160px"/>
                        <div class="overlay">
                            <div class="text" style="font-size: 13px">Click to Change Profile Image</div>
                        </div>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col text-center mt-5">
            <button type="button" class="btn btn-primary" style="width: 100px">Зберегти</button>
        </div>
    </div>
</div>
